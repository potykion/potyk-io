...
4. **Не тащить** в обзор посторонние заметки (`notes/`, invest-заметки, длинные эссе), кроме случая когда дневник на них ссылается или дата совпадает с поездкой в `templates/potyk-travel/memories/` (например `suzdal-cucumber-26` ↔ 2026-08-01).
